      ...
      next: (report: MarketingReport) => {
        this.pieChartData = {
          labels: [
            'Completed Campaigns',
            'Active Campaigns',
            'Zero Interaction Campaigns',
          ],
          data: [
            report.dataPoints.completedCampaigns,
            report.dataPoints.activeCampaigns,
            report.dataPoints.zeroInteractionCampaigns,
          ],
        };
        this.tree = [
          {
            ...
            children: [
              ...
              },
              {
                ...
                children: [
                  {
                    label:
                      report.dataPoints.totalCustomerInteractions.toString(),
                    styleClass: '!bg-orange-100 !text-orange-900 rounded-xl',
                  },
                ],
              },
