...
export class ViewTicketsComponent implements OnInit, OnChanges {
  ...
  constructor(private router: Router, private customerSupportService: CustomerSupportService, private messageService: MessageService, private confirmationService: ConfirmationService) { }
